...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=800&color=0F62FE&center=true&vCenter=true&width=650&lines=Building+intelligent+systems+that+matter;Computer+Vision+%7C+NLP+%7C+LLMs+%7C+RAG;96%25%2B+model+accuracy+in+production;HEC+GenAI+Hackathon+2025+%E2%80%94+Recognized;From+Sindh%2C+Pakistan+%F0%9F%87%B5%F0%9F%87%B0+to+the+world" alt="Typing SVG" />
</a>
...
> End-to-end GenAI platform converting natural language prompts into fully functional HTML/CSS/JS websites in **under 3 minutes**. Features multi-turn editing, real-time preview and instant hosting. Recognized at HEC GenAI Hackathon 2025 among 50+ teams.
...
> Production-grade real-time attendance system using **face_recognition (dlib)** for accurate face matching, **LBP anti-spoofing** to block printed photos and screens, and a modern **CustomTkinter dark UI** with sidebar navigation. Features auto attendance marking, live dashboard with weekly charts, photo-based student registration, smart record search, and one-click **Excel/CSV export** stored locally in SQLite.
...
> Semantic segmentation model (**U-Net + ResNet-50**) trained on NASA lunar datasets to classify safe, rocky, and crater zones for autonomous rover path-planning. Competing at ISSSP 2026.
...
> Full-featured chess app with AI opponent powered by **Minimax + Alpha-Beta Pruning**. Includes responsive GUI, sound effects, move history, board flip, and timers.
